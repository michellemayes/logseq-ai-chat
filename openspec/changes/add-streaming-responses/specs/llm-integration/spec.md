...
- **AND** citations are extracted from the complete streamed response

#### Scenario: Display streaming responses
- **WHEN** the AI generates a response
- **THEN** tokens appear in the chat interface as they are generated
- **AND** a typing indicator is shown before the first token arrives
- **AND** the message bubble updates smoothly as content streams in
